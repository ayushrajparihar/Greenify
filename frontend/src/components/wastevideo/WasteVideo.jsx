      ...
      <div className="wastevideo">
        ...
        <div className="upper">
          <div className="capture m-20">
            {!imageData && <label
              htmlFor="file-upload"
              className="relative cursor-pointer flex justify-center items-center rounded-lg border-dashed border-green-300 border-2 py-2 px-4 transition duration-300 ease-in-out hover:bg-gray-900 hover:border-gray-400"
            >
